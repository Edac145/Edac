...
// Define a structure to hold offset equation for each slave
...
// Define offset equations for each slave
OffsetEquation offsetEquations[NUM_SLAVES] = {
    { -0.0542, 0.7984 }, // Offset equation for slave 1
    { -0.0607, 0.5258 },
    { -0.0495, 0.8077 },
    { -0.0667, 0.555 },
    { -0.0387, 0.7965 },
    { -0.0476, 0.7092 }, // Offset equation for slave 6
    { -0.0462, 0.6916 },
    { -0.0351, 0.6391 },
    { -0.0488, 0.5956 },
    { -0.0578, 0.7333 },
    { -0.0509, 0.6789 }, // Offset equation for slave 11
    { -0.0487, 0.6869 },
    { -0.0574, 0.8361 },
    { -0.043, 0.5225 },
    { -0.0408, 0.5369 },
    { -0.0512, 0.7473 }, // Offset equation for slave 16
    { -0.0506, 0.9799 },
    { -0.0495, 0.7756 },
    { -0.0516, 0.7678 },
    { -0.0543, 0.6311 },
    { -0.0504, 0.8102 }, // Offset equation for slave 21
    { -0.0503, 0.7073 },
    { -0.0523, 0.9299 },
    { -0.0551, 0.8156 },
    { -0.0535, 0.9058 },
    ...
    for (int i = 0; i < NUM_SLAVES; i++)
     {
...

      {
        ...
        press = press/13.52;
        // us_press =  (int)press;
        temp = applyOffsetEquation(temp, offsetEquations[i]);
...
float calculateDepth(float pressure) {
    ...
    return (pressure) * 10.0 / PRESSURE_PER_10M;
}
...
// Function to apply offset equation and adjust temperature
float applyOffsetEquation(float temperature, OffsetEquation equation) {
    return temperature - (equation.slope * temperature + equation.intercept);
}
